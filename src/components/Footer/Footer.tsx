            ...
            <div className="row footer-content">
              <div className="col-md-4 contact-detail">
                ...
                <ul className="social-links ul_arrange text_align social-menu">
                  ...
                  <li>
                    <a href="https://www.linkedin.com/company/eraswap/" target="_blank" rel="noopener noreferrer">
                      <i className="fa fa-linkedin"></i>
                    </a>
                  </li>
                  <li>
                    <a href="https://www.instagram.com/eraswap/?hl=en" target="_blank" rel="noopener noreferrer">
              ...
              <div className="col-md-4 connect-with text_align">
                ...
                <ul className="ul_arrange text_align">
                  ...
                  <li>
                    {' '}
                    <a href="https://eraswaptoken.io/pdf/eraswap_whitepaper.pdf" target="_blank" rel="noopener noreferrer">
                      Era Swap Whitepaper
                    </a>
                  </li>
                  <li>
                    <a href="https://eraswaptoken.io/pdf/es-statuary-warning.pdf" target="_blank" rel="noopener noreferrer">
                      Statuary Warning
                    </a>
                  </li>
                  <li>
              ...
              <div className="col-md-4 term-condition text_align">
                ...
                <ul className="ul_arrange text_align">
                  <li>
                    <a href="assets/pdf/certidapp-privacy.pdf" target="_blank" rel="noopener noreferrer">
                      Privacy Policy
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="assets/pdf/certidapp-terms-conditions.pdf" target="_blank" rel="noopener noreferrer">
                      Terms & Conditions
                    </a>
                  </li>
                  <li>
